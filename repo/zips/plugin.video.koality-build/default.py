...
base='Joshless'
ADDON=xbmcaddon.Addon(id='plugin.video.koality-build')
...
def CATEGORIES():
    link = OPEN_URL('https://repo.nb-server.de/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]Koality Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
